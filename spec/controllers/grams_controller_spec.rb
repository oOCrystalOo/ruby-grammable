...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
    it "shouldn't let users that didn't create the gram to destroy it" do
    ...
    it "should allow a user to destroy gram" do
      gram = FactoryBot.create(:gram)
      sign_in gram.user
      delete :destroy, params: { id: gram.id }
    ...
    it "should return a 404 message if gram is not found" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#update action" do
    it "shouldn't allow users that didn't create the gram to update it" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
    ...
    it "should return http 404 error if the gram cannot be found" do
      user = FactoryBot.create(:user)
      sign_in user
